export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-transparent">
      <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="space-y-8">
            ...
            <section className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <div className="space-y-6">
                <div>
                  <div className="text-sm font-medium text-gray-500 mb-3">前端技术</div>
                ...
                <div>
                  <div className="text-sm font-medium text-gray-500 mb-3">后端技术</div>
                  <div className="flex flex-wrap gap-2">
                ...
                <div>
                  <div className="text-sm font-medium text-gray-500 mb-3">开发工具</div>
                  <div className="flex flex-wrap gap-2">
            ...
            <section className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  <div className="text-sm font-medium text-gray-500 mb-3">技术栈</div>
            ...
            <section className="bg-white rounded-2xl p-8 shadow-md">
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all group"
                >
                  <div className="text-2xl">📂</div>
                  <div>
                    <div className="font-medium text-gray-800 group-hover:text-blue-500 transition-colors">GitHub</div>
                ...
                <a
                  ...
                  className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg hover:border-pink-500 hover:bg-pink-50 transition-all group"
                >
                  <div className="text-2xl">📧</div>
                  <div>
                    <div className="font-medium text-gray-800 group-hover:text-pink-500 transition-colors">Email</div>
                ...
                >
                  <div className="text-2xl">🐦</div>
                  <div>
                    <div className="font-medium text-gray-800 group-hover:text-blue-500 transition-colors">Twitter</div>
                    <div className="text-sm text-gray-500">@username</div>
                  </div>
                </a>
              </div>
        ...
        <section className="bg-white rounded-2xl p-8 shadow-md">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">博客统计</h2>
            <p className="text-gray-500">持续分享，持续成长</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">建站年份</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">学习热情</div>
            </div>
          </div>
        </section>
      </div>
